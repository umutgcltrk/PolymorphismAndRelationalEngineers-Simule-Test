...
public class Projects implements Project {
    ...
    public ChiefComputerEngineer chieffComputerEngineer;
    public ChiefIndustryEngineer chieffIndustryEngineer;
    ...
    public void createProject(int id, String projectName, String description, String projectDate) {
        ...
        System.out.println("Project ID :"+id+ "\n"
                ...
                +"Project Create Date :"+projectDate + chieffComputerEngineer.getChiefName());
    }
}
